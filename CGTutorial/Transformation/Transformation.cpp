...
int main()
{
    ...
    unsigned char* data = HAUtilities::stbi_load("..\\Resources\\container.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    data = HAUtilities::stbi_load("..\\Resources\\awesomeface.png", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ourShader.SetMatrixUniform("transformMat", 1, GL_FALSE, glm::value_ptr(trans));
        ...
        ourShader.SetMatrixUniform("transformMat", 1, GL_FALSE, glm::value_ptr(trans2));
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
